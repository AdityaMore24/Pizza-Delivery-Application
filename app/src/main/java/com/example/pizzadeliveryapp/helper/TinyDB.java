...
public class TinyDB {
    ...
    public ArrayList<HomeVerModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<HomeVerModel> playerList =  new ArrayList<HomeVerModel>();

        for(String jObjString : objStrings){
            HomeVerModel player  = gson.fromJson(jObjString,  HomeVerModel.class);
    ...
    public void putListObject(String key, ArrayList<HomeVerModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(HomeVerModel player: playerList){
